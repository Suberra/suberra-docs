...
For most subscriptions services, projects will want to restrict access to only paid users. This is where Access Control comes in. Access Control allows you to restrict access to your content based on the user's subscription status.

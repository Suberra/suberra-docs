...
Suberra is non-custodial. The payer and the payee can have control over the funds at any point of time. We do not store the funds on behalf or the user and merchant, nor have any lock up of the funds on the smart contracts.

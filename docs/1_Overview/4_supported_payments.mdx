...
We are rolling out on EVM chains on a rolling basis based on customer demands. If you are interested in a specific network or token that is not supported at the moment, please contact us at hello@suberra.com  d
:::
...
We will be adding support for the Ethereum, Binance Smart Chain, Avalanche and Optimism in Q1 2023.
...
As Suberra is non-custodial, we do not store your funds on our accounts or smart contracts. You can use anything to accept incoming transactions as long as there is a persistent valid address.
...
You could also use an address from a cryptocurrency exchange, but please check with the exchange separately on whether the address is permanent and uniquely tied to your account.

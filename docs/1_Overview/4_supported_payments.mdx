...
- Avalanche
- Arbitrum
- Ethereum (invite only)

We will be adding support for the Ethereum, Binance Smart Chain and Optimism in Q2 2023.
...
We will be adding support for the XSGD, WETH, WBTC, USDT, BUSD and DAI in Q2 2023.
